package com.phics23.tenant.ui.adapters ;
 ...
 */
public class CustomArrayAdapter extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
    /**
    ...
    private final String resultEmpty = "No listings found in this city";
    /**
     * Constructor
     *
    ...
    @IdRes int textViewResourceId, @NonNull List<String> objects, boolean objsFromResources) {
        mContext = context;
     ...
     * {@link #(Object[])}, {@link #insert}, {@link #remove}, {@link #clear},
     ...
     */
    public static @NonNull CustomArrayAdapter createFromResource(@NonNull Context context,
                                                                         @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
        final String[] strings = (String[]) context.getResources().getTextArray(textArrayResId);
    ...
    private class ArrayFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                if (newValues.size()==0)
                {
                    newValues.add(resultEmpty);
                }else
                {
                    if (newValues.contains(resultEmpty))
                    {
                        try{
                            newValues.remove(resultEmpty);
                        }catch (Exception e)
                        {
                            Log.e("customArrayAdapter", "performFiltering: ",e );
