...
//                            listing.data!!.get("currentOccupants")!!.toString(),
...
//                        listing.data!!.get("listingImages") as List<String> ,
//                        listing.data!!.get("listingBhk")!!.toString(),                                       ).also { it->Log.e("list", "getMyListings: "+it.toString() ) }
//
//                )
