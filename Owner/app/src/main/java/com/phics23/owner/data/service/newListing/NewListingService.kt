package com.phics23.owner.data.service.newListing
...
class NewListingService @Inject constructor(val firebaseFirestore: FirebaseFirestore, val firebaseStorage : FirebaseStorage, val firestoreAuth: FirebaseAuth, val messaging : FirebaseMessaging) {
    ...
    suspend fun submitListing(listing : Listing) : Result<String>
    {
        val listing = hashMapOf(
            ...
            "city" to listing.city.toLowerCase(),
